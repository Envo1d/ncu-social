...
-- CreateEnum
CREATE TYPE "Status" AS ENUM ('OFFLINE', 'ONLINE', 'BANNED');
...
-- AddForeignKey
ALTER TABLE "Category" ADD CONSTRAINT "Category_generalCategoryId_fkey" FOREIGN KEY ("generalCategoryId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
